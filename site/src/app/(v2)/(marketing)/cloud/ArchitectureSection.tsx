		...
		<div className="mx-auto max-w-7xl px-6 py-32 lg:py-40">
			<div className="text-center mb-16">
				...
				<p className="mt-4 text-lg text-white/70">
					Rivet Engine orchestrates actors that connect seamlessly to your applications deployed anywhere
				</p>
			</div>
			...
			<div className="bg-[#0A0A0A] rounded-xl p-8 mb-16">
				<div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center">
					...
					<div className="flex justify-center">
						<Icon icon={faArrowRight} className="text-2xl text-white/40 rotate-90 lg:rotate-0" />
					</div>
					...
					<div className="text-center">
						<div className="bg-white/5 rounded-lg p-6 border border-white/10">
							...
							<h3 className="text-xl font-medium text-white mb-2">Rivet Engine</h3>
							<p className="text-white/60 text-sm">
								Actor orchestration with FoundationDB backend
							</p>
						</div>
					</div>
				</div>
				...
				<div className="mt-8 text-center">
					<div className="inline-flex items-center gap-3 bg-white/5 rounded-lg px-6 py-3 border border-white/10">
						<Icon icon={faDatabase} className="text-xl text-white/90" />
						<span className="text-white/90 font-medium">FoundationDB</span>
						<span className="text-white/60 text-sm">Enterprise-scale storage</span>
					</div>
				</div>
			</div>
			...
			<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
				...
				<div className="bg-white/2 rounded-lg p-6 border border-white/10">
					...
					<p className="text-white/60 text-sm">
						Connect applications from AWS, GCP, Azure, or any cloud platform to Rivet's actor orchestration.
					</p>
				</div>
			</div>
